from hypop.model import single_node, single_node_xavier, HGNN_ATT
import timeit
from itertools import chain
import torch
from hypop.loss import loss_cal_and_update, maxcut_loss_func_helper, loss_maxcut_weighted, loss_sat_weighted, loss_maxind_weighted, loss_maxind_QUBO, loss_maxind_weighted2, loss_task_weighted, loss_maxcut_weighted_anealed, loss_task_weighted_vec, loss_mincut_weighted
from hypop.utils import mapping_algo, mapping_distribution, gen_q_mis,gen_q_maxcut, mapping_distribution_QUBO, get_normalized_G_from_con, mapping_distribution_vec_task
import numpy as np
...
def centralized_train(G, params: Params, f, C, n, info, weights, file_name):
...
def centralized_train_att( H, params: Params, f, C, n, info, weights, file_name):
    temp_time = timeit.default_timer()
...
###### bipartite GNN #####
def centralized_train_bipartite( G, params: Params, f, C, n, n_hyper, info, weights, file_name):
    temp_time = timeit.default_timer()
    # fix seed to ensure consistent results
    # seed_value = 100
    # random.seed(seed_value)  # seed python RNG
